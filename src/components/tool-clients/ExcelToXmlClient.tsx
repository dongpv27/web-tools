      ...
      {!workbook ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-gray-600 mb-1">Root Element Name</label>
              <input
                type="text"
                value={rootName}
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Row Element Name</label>
              <input
                type="text"
                value={rowName}
                onChange={(e) => setRowName(e.target.value.replace(/[^a-zA-Z0-9_]/g, ''))}
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md"
              />
            </div>
          </div>
