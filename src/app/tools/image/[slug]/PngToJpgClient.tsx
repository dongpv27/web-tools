      ...
      {!image ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {processedImage && (
              <div className="border border-gray-200 rounded-lg p-4">
                <p className="text-xs text-gray-500 mb-2 text-center">Converted JPG</p>
          ...
          {/* Background Color */}
          <div>
            <label className="block text-sm text-gray-600 mb-1">Background Color (for transparent areas)</label>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={bgColor}
                onChange={(e) => setBgColor(e.target.value)}
                className="px-3 py-2 text-sm border border-gray-300 rounded-md w-28"
              />
            </div>
          </div>
